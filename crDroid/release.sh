...
if [ "$DEVICE" = "d1x" ] ; then
    ...
    response=$(jq -n --arg maintainer "Rocky7842" \
            ...
            --arg modem "" \
            --arg bootloader "" \
            --arg recovery "https://sourceforge.net/projects/projects/crdroid-samsung-note10-5g/files/crdroid-9/recovery.img/download" \
            --arg paypal "" \
            --arg telegram "" \
...
git commit -m "Update autogenerated json for $DEVICE $MAINVERSION ${DATE}/${TIMESTAMP}"
